...
// One user can schedule many inspections
User.hasMany(Inspection, { foreignKey: 'scheduled_by_user_id', as: 'inspections_scheduled' });
Inspection.belongsTo(User, { foreignKey: 'scheduled_by_user_id', as: 'scheduled_by' });
